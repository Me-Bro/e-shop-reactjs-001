...
import HeroImage from '../assets/Images/hero-page3.jpg'
        ...
        <div className='w-full md:w-3/12'>
           ...
           <div className='w-full md:w-9/12 mt-8 md:mt-0 h-96 relative'>
              ...
              <div className='absolute top-16 left-8'>
                ...
                <button className='bg-red-600 px-8 py-1.5 text-white
                mt-4 hover:bg-red-700 transform transition-transform
